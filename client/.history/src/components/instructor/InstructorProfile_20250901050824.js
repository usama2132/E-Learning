...
const handleMouseMove = useCallback((e) => {
 ...
 const confirmCrop = useCallback(() => {
  ...
  // Replace the handleSubmit function in your InstructorProfile.js
...
const handleSubmit = useCallback(async (e) => {
  ...
  try {
    ...
    if (response.ok && data.success) {
      ...
      console.error('Failed to update instructor profile:', data.message);
...
// Also add useEffect to fetch initial profile data
useEffect(() => {
  const fetchInstructorProfile = async () => {
    try {
      ...
      if (response.ok && data.success && data.data && data.data.profile) {
        const instructorData = data.data.profile.instructor;
