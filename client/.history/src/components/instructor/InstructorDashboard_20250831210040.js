...
const InstructorDashboard = () => {
  ...
  const { instructorCourses, isLoading, fetchInstructorCourses } = useCourse();
  ...
  console.log('InstructorDashboard - Courses:', instructorCourses);
  console.log('InstructorDashboard - Loading:', isLoading);

  useEffect(() => {
    if (user && (user.id || user._id) && fetchInstructorCourses) {
      console.log('Fetching instructor courses for user ID:', user.id || user._id);
