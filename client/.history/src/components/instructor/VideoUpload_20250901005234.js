...
const VideoUpload = ({ videos, setVideos, courseId }) => {
  ...
  // FIXED: Upload video to backend with correct URL
  ...
  // FIXED: Check if courseId is valid before proceeding
  if (!courseId || courseId === null || courseId === 'null') {
    throw new Error('Course must be created first before uploading videos');
  }
    ...
    // FIXED: Correct backend URL - removed extra "course-videos" 
