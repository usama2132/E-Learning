  ...
  const uploadPendingVideos = async (courseId) => {
    ...
    try {
      for (const video of pendingVideos) {
        ...
        formDataToUpload.append('title', video.title);
        formDataToUpload.append('description', video.description || '');
        formDataToUpload.append('duration', video.duration || '');
        ...
        console.log(`✅ Video uploaded: ${video.title}`, data);
