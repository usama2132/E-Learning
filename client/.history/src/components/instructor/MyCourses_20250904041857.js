...
const makeAuthenticatedRequest = useCallback(async (url, options = {}) => {
  ...
  navigate('/instructor/courses/create'); // FIXED: matches App.js route
}, [navigate]);

// Replace these handlers in MyCourses.js:

const handleEditCourse = useCallback((courseId) => {
  navigate(`/instructor/edit-course/${courseId}`); // Match App.js route
}, [navigate]);

const handleAnalytics = useCallback((courseId) => {
  navigate(`/instructor/analytics/courses`); // Match existing App.js route
}, [navigate]);

const handlePreviewCourse = useCallback((courseId) => {
  navigate(`/courses/${courseId}`); // FIXED: matches App.js route for course details
}, [navigate]);
