...
const CourseProgress = () => {
  ...
  const fetchCourseAndProgress = async () => {
    ...
    try {
      ...
      // FIXED: Ensure course has proper structure for display
      if (!courseInfo.sections || courseInfo.sections.length === 0) {
        // Create default structure with actual course data
        courseInfo.sections = [
          {
            id: 'intro-section',
      ...
      // FIXED: Ensure thumbnail and video data is properly structured
      courseInfo.sections = courseInfo.sections.map(section => ({
        ...
        lessons: (section.lessons || []).map(lesson => ({
          ...
          videoUrl: lesson.videoUrl || lesson.video?.url || courseInfo.previewVideo?.url || '',
  ...
  return (
    <div className="course-progress-container">
      ...
      <div className="course-header">
        {/* FIXED: Display course thumbnail */}
        {course.thumbnail && (
        ...
        <div className="course-info">
          ...
          {/* FIXED: Display course description */}
          {course.description && (
      ...
      {/* Course Content with thumbnails and videos */}
              ...
              <div key={section.id || sectionIndex} className="section-card">
                ...
                <div className="lessons-list">
                  {(section.lessons || []).map((lesson, lessonIndex) => (
                    ...
                    >
                      {/* FIXED: Display lesson thumbnail */}
                      {lesson.thumbnail && (
