...
const StudentProgress = () => {
  ...
  if (localLoading || loading) return <Loading />;
  ...
  if (localError || error) {
    return (
      <div style={{
        ...
        <h3 style={{ margin: 0, fontSize: '1.25rem', fontWeight: '600' }}>{localError || error}</h3>
        <button
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                backgroundColor: (localLoading || loading) ? colors.textMuted : colors.info,
                color: 'white',
                border: 'none',
                borderRadius: '0.75rem',
                fontSize: '0.875rem',
            ...
            >
              {(localLoading || loading) ? 'Refreshing...' : 'Refresh Progress Data'}
            </button>
          </div>
        </>
      )}
