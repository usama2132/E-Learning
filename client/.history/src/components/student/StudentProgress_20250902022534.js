...
const StudentProgress = () => {
  ...
  const [courseProgressData, setCourseProgressData] = useState({}); // Store progress for each course
  ...
  // FIXED: Fetch enrolled courses and their progress data
  const fetchEnrolledCourses = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // FIXED: Fetch progress data for each course
  ...
  // FIXED: Fetch progress data for all courses from backend
  const fetchProgressForAllCourses = async (courses, token) => {
    try {
      ...
      // Store progress data by course ID
      const progressMap = {};
  ...
  // FIXED: Get real progress percentage from backend data
  ...
  // FIXED: Get completed lessons count from backend
  ...
  // FIXED: Get total lessons from backend or course data
  ...
  // FIXED: Calculate overall stats using backend progress data
  ...
  return (
    <div style={{
      ...
      {enrolledCourses.length === 0 ? (
        ...
        <>
          {/* Overall Statistics - FIXED: Using backend progress data */}
          <div style={{
            display: 'grid',
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        {/* FIXED: Real-time progress bar using backend data */}
                        <ProgressBar 
                          courseId={course._id}
                    ...
                    {/* Progress Details Footer - Shows backend data status */}
                    <div style={{
                      marginTop: '1rem',
                      paddingTop: '1rem',
