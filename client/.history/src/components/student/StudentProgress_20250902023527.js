...
const StudentProgress = () => {
  ...
  const getOverallStats = () => {
    ...
    const completedLessons = enrolledCourses.reduce((sum, course) => sum + (course.progress?.completedLessons || 0), 0);
                    ...
                    <div style={{
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <div style={{
                          ...
                          <span>📊 {course.progress?.completedLessons || 0} of {course.totalLessons || 0} lessons</span>
