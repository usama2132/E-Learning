...
const handleResize = useCallback(() => {
  ...
  // Always close sidebar when switching to mobile/tablet OR when desktop width changes
  if ((wasDesktop && isNowMobileOrTablet) || (!wasDesktop && isNowDesktop) || isNowMobileOrTablet) {
    console.log('Resizing - closing sidebar for screen change');
