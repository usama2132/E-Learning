...
/>
        ...
        {/* FIXED: Add missing video lecture route */}
        <Route 
        ...
        {/* Also add this route for video by video ID */}
        <Route 
        ...
        {/* Student Progress Route */}
            <Route 
              ...
              element={
                <ProtectedRoute requiredRole="student">
                  <DashboardPageLayout>
                    <FallbackComponent componentName="Progress Tracking" message="Your progress tracking page is coming soon." />
                  </DashboardPageLayout>
                </ProtectedRoute>
              } 
            />

            {/* Student Purchase History Route */}
            <Route 
              path="/student/purchases" 
              element={
                <ProtectedRoute requiredRole="student">
                  <DashboardPageLayout>
                    <FallbackComponent componentName="Purchase History" message="Your purchase history page is coming soon." />
                  </DashboardPageLayout>
                </ProtectedRoute>
              } 
            />

            {/* Settings Route - works for all roles */}
            <Route 
              path="/settings" 
              element={
                <ProtectedRoute>
                  <DashboardPageLayout>
                    <FallbackComponent componentName="Settings" message="Settings page is coming soon." />
                  </DashboardPageLayout>
                </ProtectedRoute>
              } 
            />
