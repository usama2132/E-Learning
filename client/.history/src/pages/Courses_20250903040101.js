...
const Courses = () => {
  ...
  // Simplified filter state - only search and sort now
  ...
  const hasActiveSearch = filters.searchQuery?.trim();
    ...
    <div className={`courses-page ${isDarkMode() ? 'dark' : 'light'}`}>
      ...
      <div className="courses-page__controls">
        ...
        <div className="courses-page__results-info">
          {hasActiveSearch && (
            <button onClick={clearSearch} className="courses-page__clear-search">
              Clear Search
            </button>
          )}
        </div>
      ...
      <div className="courses-page__content courses-page__content--fullwidth">
        <main className="courses-page__main courses-page__main--fullwidth">
          {courses && courses.length > 0 ? (
            <>
              <div className="courses-page__grid courses-page__grid--fullwidth">
                {courses.map(course => (
                  <CourseCard 
            ...
            <div className="courses-page__no-results">
              <div className="courses-page__no-results-content">
                ...
                <p className="courses-page__no-results-text">
                  {hasActiveSearch 
                    ? "We couldn't find any courses matching your search. Try a different search term."
