...
const Courses = () => {
  ...
  return (
    <div className={`courses-page ${actualTheme} ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      <div className={`courses-header ${isDarkMode ? 'dark' : 'light'}`}>
        <h1>All Courses</h1>
        <p>Discover and learn from our extensive course catalog</p>
      </div>

      {/* Integrated Search and Sort Section */}
      <div className={`search-sort-section ${isDarkMode ? 'dark' : 'light'}`}>
      ...
      <div className="courses-content">
        <aside className={`filters-sidebar ${actualTheme} ${isDarkMode ? 'dark' : 'light'}`}>
          <CourseFilters 
            filters={filters}
        ...
        <main className="courses-grid-container">
          {courses && courses.length > 0 ? (
            ...
            <div className={`no-courses ${actualTheme} ${isDarkMode ? 'dark' : 'light'}`}>
