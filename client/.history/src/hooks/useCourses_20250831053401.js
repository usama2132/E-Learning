...
const useCourses = (filters = {}) => {
  ...
  const addSection = useCallback(async (courseId, sectionData) => {
    try {
      ...
      const response = await makeAPIRequest(`/courses/${courseId}/sections`, {
        method: 'POST',
  ...
  const addLesson = useCallback(async (courseId, sectionId, lessonData) => {
    try {
      ...
      const response = await makeAPIRequest(`/courses/${courseId}/sections/${sectionId}/lessons`, {
        method: 'POST',
  ...
  const addVideo = useCallback(async (courseId, sectionId, lessonId, videoData) => {
    try {
      ...
      const response = await makeAPIRequest(`/courses/${courseId}/sections/${sectionId}/lessons/${lessonId}/videos`, {
        method: 'POST',
